...
extension PickThemeViewController: UICollectionViewDataSource, UICollectionViewDelegate,
  ...
  func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
    if indexPath.section == 0 {
      ...
      if let selectedCell = themeCollectionView.cellForItem(at: indexPath)! as? ThemeCollectionViewCell {
  ...
  func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
    if indexPath.section == 0 {
      ...
      if let cellToDeselect = themeCollectionView.cellForItem(at: indexPath)! as? ThemeCollectionViewCell {
