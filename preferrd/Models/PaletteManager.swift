...
struct PaletteManager {
  static let shared = PaletteManager()
    ...
    func add(name: String,
        ...
        self.setVariables(to: palette, name: name, backgroundHex: backgroundHex, headlineHex: headlineHex, bodyHex: bodyHex, buttonBgHex: buttonBgHex, buttonTextHex: buttonTextHex)
